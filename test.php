					...
					if(in_array($filecheck,$fileextensionstore)){
						...
						while($result = mysqli_fetch_array($querydisplay)){
								...
								<div class="card" style="width: 18rem;">
  								<img class="card-img-top" src="<?php echo $result['image']; ?>" height = "300px" width = "100px" alt="Card image cap">
  								<div class="card-body">
								<h5 class="card-title">Name : <?php echo $result['name']; ?></h5>
								<p class="card-text">Phone number: <?php echo $result['phone number']; ?></p>
